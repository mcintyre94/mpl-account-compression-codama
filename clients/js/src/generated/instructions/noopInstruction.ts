...
import { MPL_NOOP_PROGRAM_ADDRESS } from '../programs';
...
export type NoopInstructionInstruction<
  TProgram extends string = typeof MPL_NOOP_PROGRAM_ADDRESS,
...
export function getNoopInstructionInstruction<
  TProgramAddress extends Address = typeof MPL_NOOP_PROGRAM_ADDRESS,
>(
  input: NoopInstructionInput,
  config?: { programAddress?: TProgramAddress }
): NoopInstructionInstruction<TProgramAddress> {
  // Program address.
  const programAddress = config?.programAddress ?? MPL_NOOP_PROGRAM_ADDRESS;
